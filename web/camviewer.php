...
<head>
    ...
    <link rel="stylesheet" href="css/vst-unit-motion.css">
    ...
    <style>
        ...
        body { background-color: #050505; color: #ccc; font-family: 'Share Tech Mono', monospace; margin: 0; padding: 0; }
        
        /* Managerが生成する旧型ヘッダーを非表示 */
        .vst-plugin .plugin-header { display: none !important; }

        header { background: #111; padding: 10px 15px; border-bottom: 2px solid #333; margin-bottom: 15px; }
        header h1 { margin: 0; font-size: 1.5rem; color: #fff; }
        .vital-unit { display: flex; gap: 15px; font-size: 0.9rem; color: #aaa; margin-top: 5px; }
    </style>
</head>
<body>
    <header>
    ...
    <main id="vst-rack" class="rack-container"></main>
    
    <script src="https://cdnjs.cloudflare.com/ajax/libs/paho-mqtt/1.0.1/mqttws31.min.js"></script>
    <script src="js/vst-unit-base.js"></script>
    <script src="js/vst-manager.js"></script>
    <script src="js/plugins/motion-unit.js"></script> <script>
        window.WES_CONFIG = {
